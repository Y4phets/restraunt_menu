...
class Meals(models.Model):
    ...
    proteins = models.PositiveIntegerField("Белки", validators=[validators.MaxValueValidator(10000)])
    fats = models.PositiveIntegerField("Жиры", validators=[validators.MaxValueValidator(10000)])
    carbohydrates = models.PositiveIntegerField("Углеводы", validators=[validators.MaxValueValidator(10000)])
